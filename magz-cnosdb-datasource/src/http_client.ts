import axios, { AxiosInstance, AxiosInterceptorManager, AxiosRequestConfig, AxiosResponse, CancelToken, CancelTokenSource } from 'axios';
import { defer, map, Observable } from 'rxjs';

export const AXIOS_SYSTEM_ERROR_CODE = ['ECONNREFUSED', 'EHOSTUNREACH', 'ECONNRESET', 'ECONNABORTED', 'EHOSTDOWN', 'ENETDOWN', 'ENETRESET', 'ENETUNREACH', 'ETIMEDOUT'];

export type PlainObject = {
    [key: string]: string | string[] | number | number[] | boolean | boolean[] | PlainObject | PlainObject[] | null | undefined;
};
...
class HttpClient {
    ...
    constructor() {
        ...
        this.service.interceptors.response.use(r => r, async (error) => {
    ...
    getJSON<T = any>(
        ...
        return this.createDeferredObservable(this.service.get<T>(path, {
            params: queryParams,
    ...
    post<T = any>(
        ...
        return this.createDeferredObservable(this.service.post<T>(path, body, {
            params: queryParams,
            headers: headers,
            cancelToken
        }));
    ...
    put<T = any>(
        ...
        return this.createDeferredObservable(this.service.put<T>(path, body, {
            headers: headers,
            params: queryParams,
            cancelToken
        }));
    ...
    delete<T = any>(
        ...
        return this.createDeferredObservable(this.service.delete<T>(path, {
            params: queryParams,
            headers: headers,
            cancelToken
        }));
